...
from settings.constants import DIRECTIONS, SNAKE_BLOCK, ZERO
...
class Snake:
    ...
    def step(self, action):
        ...
        if ((DIRECTIONS[action] + DIRECTIONS[self.current_direction_index]) != ZERO).all():
        ...
        return tuple(new_head), tuple(tail)
